(function(a) {
  a.fn.gracket = function(b) {
    ...
    var c = this,
      h =
        typeof c.data("gracket") === "undefined"
          ? []
          : typeof c.data("gracket") === "string"
          ? JSON.parse(c.data("gracket"))
          : c.data("gracket"),
      j,
      i,
      f,
    ...
    var d = {
      build: {
          ...
          var k = [
            "<h3" +
              (typeof m.score === "undefined"
                ...
                : ' title="Score: ' + m.score + '"') +
              ">",
            '<span class="' + l.seedClass + '">',
            typeof m.displaySeed === "undefined" ? m.seed : m.displaySeed,
            "</span>",
            "&nbsp;" + m.name + "&nbsp;",
            "<small>",
            typeof m.score === "undefined" ? "" : m.score,
            "</small>",
            "</h3>"
          ].join("");
          return (team = a("<div />", {
        ...
        game: function(k) {
          return (game = a("<div />", { class: k.gameClass }));
        },
        round: function(k) {
          return (round = a("<div />", { class: k.roundClass }));
        },
        spacer: function(m, n, l, k) {
          return (spacer = a("<div />", { class: m.spacerClass }).css({
            height: k
              ? (Math.pow(2, l) - 1) * (n / 2)
              : (Math.pow(2, l) - 1) * n
          }));
        ...
        labels: function(n, q) {
          ...
          for (l = 0; l < k; l++) {
            ...
            a("<h5 />", {
              ...
              .css({ position: "absolute", left: o, width: q.width })
              .prependTo(c);
            m += e[l];
          }
        },
        canvas: {
          ...
          draw: function(F, O, M) {
            ...
            if (typeof console !== "undefined") {
              // console.info(
              //   "Padding Left: " + J + "px",
              //   "Player/Name Width: " + n + "px",
              //   "Container padding left: " + w + "px"
              // );
            }
            if (x > o / 3) {
              x = o / 3;
      ...
      align: {
        winner: function(l, m, o) {
          ...
          return l.addClass(m.winnerClass).css({ "margin-top": n });
        }
      },
